...
import { Ban, Bug, CircleX } from "lucide-react";
...
const runClipCmd = (cmdObj, span) => {
  switch (cmdObj.cmd) {
    ...
    case "tag-prop":
      if (span.tags !== undefined && span.tags[cmdObj.val] !== undefined)
        return span.tags[cmdObj.val];
