...
import { formatDuration } from "../../components/trace/DetailedTraceSummary/util/timestamp";
...
const ICON = {
  errorIcon: (
    ...
    >
      ...
      /> */}
      <CircleX size={16} color="#F85149" style={{ marginBottom: 1.5 }} />
    </span>
  ),
  successIcon: (
    <span
    ...
    >
      ...
      /> */}
      <CircleCheck size={16} color="#238636" style={{ marginBottom: 1.5 }} />
    </span>
  ),
};
